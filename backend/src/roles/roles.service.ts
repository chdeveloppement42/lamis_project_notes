...
export class RolesService {
  ...
  // ─── DELETE ROLE ───────────────────────────────────────────────
  // Rule: When a role is deleted, all users with that role are auto-suspended
  async remove(id: number) {
    ...
    // Suspend all admins with this role
    ...
    // Move suspended admins to a default role if one exists, or we just leave them suspended
    // For now, we need to handle the FK constraint — reassign to default Manager role
